...
TEST_CASE_METHOD(SemanticTestsFixture, "SemanticProperty_WithIntDefaultValue") {
  Vec<Unique<ast::Declaration>> ast;
  ast.emplace_back(makeUnique<ast::PropertyDeclaration>(
      "value", VellumType::unresolved("Int"), "",
...
TEST_CASE_METHOD(SemanticTestsFixture,
  ...
  ast.emplace_back(makeUnique<ast::PropertyDeclaration>(
      ...
      makeUnique<ast::BlockStatement>(ast::FunctionBody{}),
      makeUnique<ast::BlockStatement>(ast::FunctionBody{}), VellumLiteral()));
...
TEST_CASE_METHOD(SemanticTestsFixture,
  ...
  Vec<Unique<ast::Declaration>> ast;
  ast.emplace_back(makeUnique<ast::PropertyDeclaration>(
      "readonlyVal", VellumType::unresolved("Int"), "",
...
TEST_CASE_METHOD(SemanticTestsFixture, "SemanticCall_NoArgs") {
  ...
  REQUIRE(test_func.getBody()->getStatements().size() == 1);
  const auto& expr_stmt = dynamic_cast<ast::ExpressionStatement&>(
      *test_func.getBody()->getStatements()[0]);
  const auto& call =
...
TEST_CASE_METHOD(SemanticTestsFixture,
  ...
  VellumObject testObject(VellumType::identifier("TestObject"));
  testObject.addProperty(VellumProperty(
      VellumIdentifier("readonlyProp"),
      VellumType::literal(VellumLiteralType::Int), staticFunctionModifier));
  addTestObject(testObject);
...
TEST_CASE_METHOD(SemanticTestsFixture, "SemanticAssign_ToFunction_Error") {
  ...
  testObject.addFunction(VellumFunction(
      ...
      Vec<VellumVariable>{}, noFunctionModifiers));
  addTestObject(testObject);
...
TEST_CASE_METHOD(SemanticTestsFixture,
  ...
  ast.emplace_back(makeUnique<ast::FunctionDeclaration>(
      "bar", Vec<ast::FunctionParameter>{}, VellumType::unresolved("Int"),
      makeUnique<ast::BlockStatement>(std::move(barBody))));
...
TEST_CASE_METHOD(SemanticTestsFixture,
  ...
  VellumObject testObject(VellumType::identifier("TestObject"));
  testObject.addProperty(VellumProperty(
      VellumIdentifier("myProperty"),
      VellumType::literal(VellumLiteralType::Int), noFunctionModifiers));
  addTestObject(testObject);
...
TEST_CASE_METHOD(SemanticTestsFixture,
  ...
  parentObj.addFunction(VellumFunction(
      VellumIdentifier("foo"), VellumType::literal(VellumLiteralType::Int), {},
      noFunctionModifiers));
...
TEST_CASE_METHOD(SemanticTestsFixture,
  ...
  VellumObject parentObj(VellumType::identifier("ParentScript"));
  parentObj.addProperty(VellumProperty(
...
TEST_CASE_METHOD(SemanticTestsFixture,
  ...
  VellumObject parentObj(VellumType::identifier("ParentScript"));
  parentObj.addFunction(VellumFunction(
      VellumIdentifier("inherited"),
      VellumType::literal(VellumLiteralType::Bool), {}, noFunctionModifiers));
  addTestObject(parentObj);
...
// ============================================================================
// Modifier validation (semantic phase)
// ============================================================================

TEST_CASE_METHOD(SemanticTestsFixture, "Semantic_StaticEventRejected") {
  Vec<Unique<ast::Declaration>> members;
  members.push_back(makeUnique<ast::FunctionDeclaration>(
      "onActivate", Vec<ast::FunctionParameter>{}, VellumType::none(),
      makeUnique<ast::BlockStatement>(Vec<Unique<ast::Statement>>{}),
      staticParsedModifiers, std::nullopt, std::nullopt, true));
...
TEST_CASE_METHOD(SemanticTestsFixture,
                 "Semantic_StaticEventAndNativeBodyErrorsBatched") {
  Vec<Unique<ast::Statement>> body;
  body.emplace_back(makeUnique<ast::ReturnStatement>(
  ...
  members.push_back(makeUnique<ast::FunctionDeclaration>(
      "onActivate", Vec<ast::FunctionParameter>{}, VellumType::none(),
      makeUnique<ast::BlockStatement>(std::move(body)),
      staticNativeParsedModifiers, std::nullopt, std::nullopt, true));
  ...
  REQUIRE(errorHandler->hasError(CompilerErrorKind::InvalidModifier));
  REQUIRE_FALSE(
      errorHandler->hasError(CompilerErrorKind::NativeFunctionWithBody));
}

TEST_CASE_METHOD(SemanticTestsFixture,
                 "Semantic_ConditionalOnAutoPropertyAccepted") {
  Vec<Unique<ast::Declaration>> members;
  members.push_back(makeUnique<ast::PropertyDeclaration>(
      "flag", VellumType::unresolved("Bool"), "",
      makeUnique<ast::BlockStatement>(Vec<Unique<ast::Statement>>{}),
      makeUnique<ast::BlockStatement>(Vec<Unique<ast::Statement>>{}),
      std::nullopt, Token{}, Token{},
      ParsedModifiers{{VellumModifier::Conditional,
...
TEST_CASE_METHOD(SemanticTestsFixture, "State_OnlyOneAutoState") {
  ...
  ast.emplace_back(makeUnique<ast::StateDeclaration>(
      "State1", makeToken(TokenType::IDENTIFIER, 1, "State1"),
      autoParsedModifiers, Vec<Unique<ast::Declaration>>{}));

  // Second auto state - should error
  ast.emplace_back(makeUnique<ast::StateDeclaration>(
      "State2", makeToken(TokenType::IDENTIFIER, 2, "State2"),
      autoParsedModifiers, Vec<Unique<ast::Declaration>>{}));
...
TEST_CASE_METHOD(SemanticTestsFixture, "State_OnlyFunctionsAllowed") {
  ...
  ast.emplace_back(makeUnique<ast::StateDeclaration>(
      "MyState", makeToken(TokenType::IDENTIFIER, 1, "MyState"),
...
TEST_CASE_METHOD(SemanticTestsFixture, "State_FunctionMustBeInEmptyState") {
  ...
  stateMembers.emplace_back(makeUnique<ast::FunctionDeclaration>(
      ...
      makeUnique<ast::BlockStatement>(Vec<Unique<ast::Statement>>{}),
      noParsedModifiers, makeToken(TokenType::IDENTIFIER, 1, "myFunc")));
...
TEST_CASE_METHOD(SemanticTestsFixture,
  ...
  stateMembers.emplace_back(makeUnique<ast::FunctionDeclaration>(
      ...
      makeUnique<ast::BlockStatement>(Vec<Unique<ast::Statement>>{}),
      noParsedModifiers, makeToken(TokenType::IDENTIFIER, 2, "onBeginState")));
...
TEST_CASE_METHOD(SemanticTestsFixture,
  ...
  stateMembers.emplace_back(makeUnique<ast::FunctionDeclaration>(
      ...
      makeUnique<ast::BlockStatement>(Vec<Unique<ast::Statement>>{}),
      noParsedModifiers, makeToken(TokenType::IDENTIFIER, 2, "OnEndState")));
...
TEST_CASE_METHOD(SemanticTestsFixture,
  ...
  scriptMembers.emplace_back(makeUnique<ast::FunctionDeclaration>(
      ...
      VellumType::unresolved("Int"),
      makeUnique<ast::BlockStatement>(Vec<Unique<ast::Statement>>{}),
      noParsedModifiers, makeToken(TokenType::IDENTIFIER, 1, "onBeginState")));
...
TEST_CASE_METHOD(SemanticTestsFixture, "State_FunctionSignatureMustMatch") {
  ...
  stateMembers.emplace_back(makeUnique<ast::FunctionDeclaration>(
      ...
      makeUnique<ast::BlockStatement>(Vec<Unique<ast::Statement>>{}),
      noParsedModifiers, makeToken(TokenType::IDENTIFIER, 2, "myFunc")));
...
TEST_CASE_METHOD(SemanticTestsFixture, "NativeFunction_NoBody_Ok") {
  Vec<Unique<ast::Declaration>> scriptMembers;
  scriptMembers.emplace_back(makeUnique<ast::FunctionDeclaration>(
      "getPlayer", Vec<ast::FunctionParameter>{}, VellumType::unresolved("Int"),
      makeUnique<ast::BlockStatement>(Vec<Unique<ast::Statement>>{}),
      nativeParsedModifiers, makeToken(TokenType::IDENTIFIER, 1, "getPlayer")));
...
TEST_CASE_METHOD(SemanticTestsFixture, "NativeFunction_WithBody_Errors") {
  Vec<Unique<ast::Statement>> body;
  body.emplace_back(makeUnique<ast::ReturnStatement>(
      makeUnique<ast::LiteralExpression>(VellumLiteral(1)),
  ...
  scriptMembers.emplace_back(makeUnique<ast::FunctionDeclaration>(
      "getPlayer", Vec<ast::FunctionParameter>{}, VellumType::unresolved("Int"),
      makeUnique<ast::BlockStatement>(std::move(body)), nativeParsedModifiers,
  ...
  REQUIRE(errorHandler->hadError());
  REQUIRE(errorHandler->hasError(CompilerErrorKind::NativeFunctionWithBody));
}
...
TEST_CASE_METHOD(SemanticTestsFixture, "State_ValidAutoState") {
  ...
  ast.emplace_back(makeUnique<ast::StateDeclaration>(
      "MyState", makeToken(TokenType::IDENTIFIER, 2, "MyState"),
      autoParsedModifiers, std::move(stateMembers)));
...
TEST_CASE_METHOD(SemanticTestsFixture,
  ...
  ast.emplace_back(makeUnique<ast::StateDeclaration>(
      "State1", makeToken(TokenType::IDENTIFIER, 2, "State1"),
      noParsedModifiers, std::move(state1Members)));
  ...
  state2Members.emplace_back(makeUnique<ast::FunctionDeclaration>(
      "myFunc", Vec<ast::FunctionParameter>{}, VellumType::unresolved("Int"),
      makeUnique<ast::BlockStatement>(Vec<Unique<ast::Statement>>{}),
      noParsedModifiers, makeToken(TokenType::IDENTIFIER, 3, "myFunc")));

  ast.emplace_back(makeUnique<ast::StateDeclaration>(
      "State2", makeToken(TokenType::IDENTIFIER, 3, "State2"),
      noParsedModifiers, std::move(state2Members)));
...
TEST_CASE_METHOD(SemanticTestsFixture, "State_EmptyStateAllowed") {
  ...
  ast.emplace_back(makeUnique<ast::StateDeclaration>(
      "MyState", makeToken(TokenType::IDENTIFIER, 2, "MyState"),
      noParsedModifiers, Vec<Unique<ast::Declaration>>{}));
...
TEST_CASE_METHOD(SemanticTestsFixture, "State_MultipleFunctionsInState") {
  ...
  stateMembers.emplace_back(makeUnique<ast::FunctionDeclaration>(
      "func1", Vec<ast::FunctionParameter>{}, VellumType::unresolved("Int"),
      makeUnique<ast::BlockStatement>(Vec<Unique<ast::Statement>>{}),
      noParsedModifiers, makeToken(TokenType::IDENTIFIER, 2, "func1")));
  stateMembers.emplace_back(makeUnique<ast::FunctionDeclaration>(
      "func2", Vec<ast::FunctionParameter>{}, VellumType::unresolved("Bool"),
      makeUnique<ast::BlockStatement>(Vec<Unique<ast::Statement>>{}),
      noParsedModifiers, makeToken(TokenType::IDENTIFIER, 2, "func2")));
...
TEST_CASE_METHOD(SemanticTestsFixture, "State_Reopen_DuplicateFunction_Error") {
  ...
  ast.emplace_back(makeUnique<ast::StateDeclaration>(
      "Merged", makeToken(TokenType::IDENTIFIER, 2, "Merged"),
      noParsedModifiers, std::move(s1)));

  Vec<Unique<ast::Declaration>> s2;
  s2.emplace_back(intFunc("foo", 3));
  ast.emplace_back(makeUnique<ast::StateDeclaration>(
      "Merged", makeToken(TokenType::IDENTIFIER, 3, "Merged"),
      noParsedModifiers, std::move(s2)));
...
TEST_CASE_METHOD(SemanticTestsFixture,
  ...
  members.push_back(makeUnique<ast::FunctionDeclaration>(
      ...
      makeUnique<ast::BlockStatement>(std::move(body)), staticParsedModifiers));
...
TEST_CASE_METHOD(SemanticTestsFixture, "ForIn_NonArrayCollection_Error") {
  ...
  body.push_back(makeUnique<ast::ForStatement>(
      makeUnique<ast::IdentifierExpression>(VellumIdentifier("i"), tokI),
      std::move(intLit), makeUnique<ast::BlockStatement>(std::move(forBody)),
      tokI, intTok));
...
TEST_CASE_METHOD(SemanticTestsFixture, "ForIn_OverFormList_NoError") {
  addTestObject(VellumObject(VellumType::identifier("Form")));
  addTestObject(VellumObject(VellumType::identifier("FormList")));
  ...
  CHECK(forStmt->getCollectionKind() ==
        ast::ForStatement::CollectionKind::FormList);
  CHECK(forStmt->getVariableName()->getType().asIdentifier().toString() ==
        "Form");
}

TEST_CASE_METHOD(SemanticTestsFixture, "ForIn_IndexedArray_IndexIsInt") {
  Token tokA = makeToken(TokenType::IDENTIFIER, 1, "a");
  Token tokItem = makeToken(TokenType::IDENTIFIER, 1, "item");
  Token tokI = makeToken(TokenType::IDENTIFIER, 1, "i");
  auto newArr = makeUnique<ast::NewArrayExpression>(
  ...
  REQUIRE(forStmt != nullptr);
  REQUIRE(forStmt->hasIndex());
  CHECK(forStmt->getIndexName()->getType().isInt());
  CHECK(forStmt->getCollectionKind() ==
        ast::ForStatement::CollectionKind::Array);
  CHECK(forStmt->getCounterMangledName() == "item_index_1");
...
TEST_CASE_METHOD(SemanticTestsFixture,
                 "ForIn_DuplicateValueAndIndexName_Error") {
  Token tokA = makeToken(TokenType::IDENTIFIER, 1, "a");
  Token tokI = makeToken(TokenType::IDENTIFIER, 1, "i");
  auto newArr = makeUnique<ast::NewArrayExpression>(
      VellumType::literal(VellumLiteralType::Int), VellumLiteral(1), Token{});
...
TEST_CASE_METHOD(SemanticTestsFixture, "ForIn_Range_IntBounds_Ok") {
  Token tokI = makeToken(TokenType::IDENTIFIER, 1, "i");
  ...
  body.push_back(makeUnique<ast::ForStatement>(
      ...
      makeUnique<ast::RangeExpression>(
          makeUnique<ast::LiteralExpression>(VellumLiteral(0)),
          makeUnique<ast::LiteralExpression>(VellumLiteral(5)), rangeTok),
  ...
  REQUIRE(forStmt != nullptr);
  CHECK(forStmt->getCollectionKind() ==
        ast::ForStatement::CollectionKind::Range);
  CHECK(forStmt->getVariableName()->getType().isInt());
}

TEST_CASE_METHOD(SemanticTestsFixture, "ForIn_Range_EmptyEqualBounds_Ok") {
  Token tokI = makeToken(TokenType::IDENTIFIER, 1, "i");
  Token rangeTok = makeToken(TokenType::DOT_DOT, 1, "..");
...
TEST_CASE_METHOD(SemanticTestsFixture, "ForIn_Range_FloatBound_Error") {
  Token tokI = makeToken(TokenType::IDENTIFIER, 1, "i");
  Token rangeTok = makeToken(TokenType::DOT_DOT, 1, "..");
  ...
  body.push_back(makeUnique<ast::ForStatement>(
      makeUnique<ast::IdentifierExpression>(VellumIdentifier("i"), tokI),
      makeUnique<ast::RangeExpression>(
          makeUnique<ast::LiteralExpression>(VellumLiteral(0.0f)),
          makeUnique<ast::LiteralExpression>(VellumLiteral(5)), rangeTok),
      makeUnique<ast::BlockStatement>(std::move(forBody)), tokI, rangeTok));
...
TEST_CASE_METHOD(SemanticTestsFixture, "ForIn_Range_IndexBinding_Error") {
  Token tokI = makeToken(TokenType::IDENTIFIER, 1, "i");
  Token tokJ = makeToken(TokenType::IDENTIFIER, 1, "j");
  Token rangeTok = makeToken(TokenType::DOT_DOT, 1, "..");
  ...
  body.push_back(makeUnique<ast::ForStatement>(
      ...
      makeUnique<ast::RangeExpression>(
          ...
          makeUnique<ast::LiteralExpression>(VellumLiteral(5)), rangeTok),
      makeUnique<ast::BlockStatement>(std::move(forBody)), tokI, rangeTok,
      makeUnique<ast::IdentifierExpression>(VellumIdentifier("j"), tokJ),
      tokJ));
...
TEST_CASE_METHOD(SemanticTestsFixture, "RangeExpression_OutsideFor_Error") {
  Token rangeTok = makeToken(TokenType::DOT_DOT, 1, "..");
...
TEST_CASE_METHOD(SemanticTestsFixture,
  ...
  innerForWrapper.push_back(makeUnique<ast::ForStatement>(
      ...
      makeUnique<ast::BlockStatement>(std::move(innerMost)), tokI, tokB));
  ...
  const auto* outerBodyBlock =
      dynamic_cast<const ast::BlockStatement*>(outerFor->getBody().get());
  REQUIRE(outerBodyBlock != nullptr);
  const auto* innerFor = dynamic_cast<const ast::ForStatement*>(
      outerBodyBlock->getStatements()[0].get());
  REQUIRE(innerFor != nullptr);
  CHECK(innerFor->getCounterMangledName() == "i_index_2");

  const auto* innerBodyBlock =
      dynamic_cast<const ast::BlockStatement*>(innerFor->getBody().get());
  REQUIRE(innerBodyBlock != nullptr);
  const auto* innerExpr = dynamic_cast<const ast::ExpressionStatement*>(
      innerBodyBlock->getStatements()[0].get());
